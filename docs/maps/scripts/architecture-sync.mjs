...
const ROOT = repoRoot()
const CONFIG = 'docs/maps/architecture/architecture.config.json'

/** Defaults for a JS/TS repo; `docs/maps/architecture/architecture.config.json` overrides them. */
const DEFAULTS = {
  coverage: 'docs/maps/architecture/coverage.json',
  output: 'docs/maps/architecture/measured.generated.ts',
