...
type Audio struct {
	...
	ParentAudioID *uuid.UUID     `gorm:"type:uuid;index;uniqueIndex" json:"parentAudioId"`
	CreatedAt     time.Time      `gorm:"autoCreateTime" json:"createdAt"`

	Device      Devices `gorm:"foreignKey:DeviceID;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE" json:"-"`
	ParentAudio *Audio  `gorm:"foreignKey:ParentAudioID;references:ID;constraint:OnUpdate:CASCADE,OnDelete:CASCADE" json:"-"`
}
