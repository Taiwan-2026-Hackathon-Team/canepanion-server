...
const CONFIG = 'architecture-webrtc.config.json'

const DEFAULTS = {
  coverage: 'src/architecture-webrtc/coverage.json',
  output: 'src/architecture-webrtc/measured.generated.ts',
  sources: [
    'cmd/main.go',
    'infra/routes.go',
...
function render({ measured, unclaimed }) {
  ...
  return `/**
 * @generated by scripts/architecture-webrtc-sync.mjs — do not edit.
 *
